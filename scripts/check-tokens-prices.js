...
async function main () {
    ...
    for (let i = 0; i < tokenlist.length; i++) {
        ...
        const currentImplPrice = await offchainOracle.getRateToEth(token.address, true);
        const deployedOraclePrice = await deployedOffchainOracle.getRateToEth(token.address, true);
